      ...
      <div className="flex flex-col h-full">
        ...
        >
          ...
          <button
            ...
            className="border-t hover:bg-[#ffffff15] border-dim py-7 text-[#8ab4f8] font-medium tracking-wider flex justify-center items-center gap-2 uppercase select-none"
          >
            Checkout
          </button>
        </div>
